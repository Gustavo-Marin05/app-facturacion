...
export const getAllProductController = async (req, res) => {
  try {
    const products = await getAllProducts(req.user);
...
export const getaProductController = async (req, res) => {
  try {
    const product = await getaProduct(req.params.id, req.user);
...
export const deleteProductController = async (req, res) => {
  try {
    const result = await deleteProduct(req.user, req.params.id);
